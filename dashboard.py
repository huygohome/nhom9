...
class IMS:
    def __init__(self,root):
        ...
        # === title =====
        # self.icon_title=PhotoImage(file="D:\PYTHON_01\py1\images\logo1.png")
        # self.icon_title = PhotoImage(file="images/logo1.png")
        img = Image.open("images/logo1.png").resize((50, 50), Image.Resampling.LANCZOS)  # Resize với bộ lọc mới
        ...
        # === clock =====
        self.lbl_clock = Label(self.root, text="Welcome to Management System\t\t Date: DD-MM-YYYY\t\t Time: HH:MM:SS",font=("times new roman",15),bg="#010c48",fg="white")
        ...
        img1 = Image.open("images/side.png").resize((38, 38), Image.Resampling.LANCZOS)  # Resize với bộ lọc mới
        ...
        btn_sales = Button(LeftMenu, text="Sales", image=self.icon_side,command=self.sales, compound=LEFT, padx=5, anchor="w",font=("times new roman",20,"bold"),bg="white",bd=3, cursor="hand2").pack(side=TOP,fill=X)
        btn_exit = Button(LeftMenu, text="Exit", image=self.icon_side,command=close_program, compound=LEFT, padx=5, anchor="w",font=("times new roman",20,"bold"),bg="white",bd=3, cursor="hand2").pack(side=TOP,fill=X)
