...
class BillClass:
    def __init__(self, root):
        ...
        btn_logout = Button(self.root, text="Logout",command=self.logout, font=("times new roman", 15, "bold"), bg="yellow",
                            cursor="hand2").place(x=1150, y=10, height=30, width=150)
        # ===clock===
        ...
        pTitle = Label(ProductFrame1, text="All Product", font=("goudy old style", 20, "bold"), bg="#262626",
        ...
        self.lbl_amnt = Label(billMenuFrame, text='Bill Amonut\n[0]', font=("goudy old style", 15, "bold"),
                              bg="#3f51b5", fg="white")
        ...
        self.lbl_net_pay = Label(billMenuFrame, text='Net Pay\n[0]', font=("goudy old style", 15, "bold"), bg="#067d8b",
                                 fg="white")
